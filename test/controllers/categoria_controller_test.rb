...
class CategoriaControllerTest < ActionController::TestCase
  ...
  test "should create categorium" do
    assert_difference('Categorium.count') do
      post :create, categorium: { Idcategoria: @categorium.Idcategoria, descripcion: @categorium.descripcion, nombrecategoria: @categorium.nombrecategoria, producto_id: @categorium.producto_id }
    end
  ...
  test "should update categorium" do
    patch :update, id: @categorium, categorium: { Idcategoria: @categorium.Idcategoria, descripcion: @categorium.descripcion, nombrecategoria: @categorium.nombrecategoria, producto_id: @categorium.producto_id }
    assert_redirected_to categorium_path(assigns(:categorium))
  end
