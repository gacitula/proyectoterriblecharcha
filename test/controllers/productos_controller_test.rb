...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { Idcategoria: @producto.Idcategoria, Idproducto: @producto.Idproducto, nombreproducto: @producto.nombreproducto, stock: @producto.stock }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { Idcategoria: @producto.Idcategoria, Idproducto: @producto.Idproducto, nombreproducto: @producto.nombreproducto, stock: @producto.stock }
    assert_redirected_to producto_path(assigns(:producto))
  end
