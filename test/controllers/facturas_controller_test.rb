...
class FacturasControllerTest < ActionController::TestCase
  ...
  test "should create factura" do
    assert_difference('Factura.count') do
      post :create, factura: { Idfactura: @factura.Idfactura, cliente_id: @factura.cliente_id, fecha: @factura.fecha, rutcliente: @factura.rutcliente }
    end
  ...
  test "should update factura" do
    patch :update, id: @factura, factura: { Idfactura: @factura.Idfactura, cliente_id: @factura.cliente_id, fecha: @factura.fecha, rutcliente: @factura.rutcliente }
    assert_redirected_to factura_path(assigns(:factura))
  end
